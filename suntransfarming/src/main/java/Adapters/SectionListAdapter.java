...
import com.suntrans.suntranswater.R;
...
public class SectionListAdapter extends BaseAdapter {
	...
	@Override
	public int getCount() {
		// total together all.xml sections, plus one for each section header
        int total = 0; 
	...
	public int getViewTypeCount() {  
        // assume that headers count as one, then total all.xml sections
        int total = 1;  
        for (Adapter adapter : this.sections.values())  
