...
public class jiexi {
	...
	//2.用于解析Inquery_Channel返回数据的静态方法
	...
	//8.用于解析Inqurey_WindFreq返回数据的静态方法
	public static ArrayList<Map<String, String>> inquiry_windfreq(SoapObject result) {
		// TODO Auto-generated constructor stub
		ArrayList<Map<String, String>> data = new ArrayList<Map<String, String>>();
		try{
			result = (SoapObject)result.getProperty(1); 
			...
			for(int i=0;  i< result.getPropertyCount(); i++ ){
				SoapObject soap = (SoapObject) result.getProperty(i);
			    Map<String, String> map=new HashMap<String,String>();
			    try{map.put("Sid", soap.getProperty("Sid").toString());}catch(Exception e){}  //传感器id
			    try{map.put("colArea", soap.getProperty("colArea").toString());}catch(Exception e){}          //风向
				try{map.put("colFreq", soap.getProperty("colFreq").toString());}catch(Exception e){}  //频率
	...
	//9.用于解析Inqurey_Sensors返回数据的静态方法
	public static ArrayList<Map<String, String>> inquiry_sensors(SoapObject result) {
		// TODO Auto-generated constructor stub
		ArrayList<Map<String, String>> data = new ArrayList<Map<String, String>>();
		try{
			result = (SoapObject)result.getProperty(1); 
			...
			for(int i=0;  i< result.getPropertyCount(); i++ ){
				SoapObject soap = (SoapObject) result.getProperty(i);
			    Map<String, String> map=new HashMap<String,String>();
			    try{map.put("Addr", soap.getProperty("Addr").toString());}catch(Exception e){}  //站点地址
			    try{map.put("AddrName", soap.getProperty("AddrName").toString());}catch(Exception e){}          //站点名称
				try{map.put("Sid", soap.getProperty("Sid").toString());}catch(Exception e){}  //传感器ID
				try{map.put("SensorName", soap.getProperty("SensorName").toString());}catch(Exception e){}     //传感器名称
				try{map.put("ShortName", soap.getProperty("ShortName").toString());}catch(Exception e){}  //传感器名称简称
				data.add(map);
	...
	//10.用于解析Inqurey_HisData返回数据的静态方法
	public static ArrayList<Map<String, String>> inquiry_hisdata(SoapObject result) {
		...
		try{
			...
			for(int i=0;  i< result.getPropertyCount(); i++ ){
				SoapObject soap = (SoapObject) result.getProperty(i);
			    Map<String, String> map=new HashMap<String,String>();
			    try{map.put("Sid", soap.getProperty("Sid").toString());}catch(Exception e){}  //传感器
			    try{map.put("GetTime", soap.getProperty("GetTime").toString());}catch(Exception e){}      //时间
			    try{map.put("Value", soap.getProperty("Value").toString());}catch(Exception e){}  //值
			    try{map.put("Unit", soap.getProperty("Unit").toString());}catch(Exception e){}  //楼层
	...
	//11.用于解析Inqurey_RealData返回数据的静态方法
	public static ArrayList<Map<String, String>> inquiry_realdata(SoapObject result) {
		// TODO Auto-generated constructor stub
		ArrayList<Map<String, String>> data = new ArrayList<Map<String, String>>();
		try{
			result = (SoapObject)result.getProperty(1); 
			...
			for(int i=0;  i< result.getPropertyCount(); i++ ){
			    ...
			    Map<String, String> map=new HashMap<String,String>();
			    try{map.put("Addr", soap.getProperty("Addr").toString());}catch(Exception e){}  //站点地址
			    try{map.put("idModu", soap.getProperty("idModu").toString());}catch(Exception e){}
			    try{map.put("Sid", soap.getProperty("Sid").toString());}catch(Exception e){}  //传感器ID
			    try{map.put("Name", soap.getProperty("Name").toString());}catch(Exception e){}  //参数名称
			    try{map.put("ShortName", soap.getProperty("ShortName").toString());}catch(Exception e){}      //名称简写
			    try{map.put("Unit", soap.getProperty("Unit").toString());}catch(Exception e){}  //单位
			    try{map.put("GetTime", soap.getProperty("GetTime").toString());}catch(Exception e){}      //更新时间
			    try{map.put("Value", soap.getProperty("Value").toString());}catch(Exception e){}  //参数值
	...
	//12.用于解析Inqurey_Sites返回数据的静态方法
	public static ArrayList<Map<String, String>> inquiry_sites(SoapObject result) {
		// TODO Auto-generated constructor stub
		ArrayList<Map<String, String>> data = new ArrayList<Map<String, String>>();
		try{
			result = (SoapObject)result.getProperty(1); 
			...
			for(int i=0;  i< result.getPropertyCount(); i++ ){
			    ...
			    Map<String, String> map=new HashMap<String,String>();
			    try{map.put("Addr", soap.getProperty("Addr").toString());}catch(Exception e){}  //站点地址
			    try{map.put("Freq", soap.getProperty("Freq").toString());}catch(Exception e){}      //采集频率
			    try{map.put("Name", soap.getProperty("Name").toString());}catch(Exception e){}  // 站点名称
			    try{map.put("idDistrict", soap.getProperty("idDistrict").toString());}catch(Exception e){}  //直属单位
	...
	public static ArrayList<Map<String, String>> inquiry_threephase_r(SoapObject result) {
		...
		try{
			...
			for(int i=0;  i< result.getPropertyCount(); i++ ){
			    ...
			    try{map.put("LossDay", soap.getProperty("LossDay").toString());}catch(Exception e){}      //当日损耗量
			    try{map.put("LossMonth", soap.getProperty("LossMonth").toString());}catch(Exception e){}      //当月损耗量
			    try{map.put("LossSum", soap.getProperty("LossSum").toString());}catch(Exception e){}      //总损耗量
			    try{map.put("LossRateDay", soap.getProperty("LossRateDay").toString());}catch(Exception e){}      //当日损耗率
			    try{map.put("LossRateMonth", soap.getProperty("LossRateMonth").toString());}catch(Exception e){}      //当月损耗率
			    try{map.put("LossRateSum", soap.getProperty("LossRateSum").toString());}catch(Exception e){}      //总损耗率
