...
public class ThreeHisData_Activity extends Activity {
	...
	private String Area,Building,Unit,Name;   //  园区，楼栋，单元   Name是显示的内容，中文
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Field=intent.getStringExtra("Type");    //参数英文名：VolA,VolB,VolC,IA,IB,IC,ActivePower,ReactivePower,PowerRateC,EletricityValue
		Name=intent.getStringExtra("Name");   //中文名称
		Area=intent.getStringExtra("Area");   //园区
		Building=intent.getStringExtra("Building");   //楼栋+单元
			...
			try{
				...
				switch(Showing)
				{
					case -1:   //日
					{
						...
						SoapObject result=soap.Inquiry_Threephase_H(Area,Building,Unit,AccountType,Field,"1",StartTime,EndTime);
					...
					case  0:    //周
					{
						...
						SoapObject result=soap.Inquiry_Threephase_H(Area,Building,Unit,AccountType,Field,"24",StartTime,EndTime);
						datalist_hisdata=jiexi.inquiry_threephase_h(result);  //获取历史信息列表				
						break;
					}
					case  1:    //月
