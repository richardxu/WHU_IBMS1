...
public class Expense_Activity extends Activity {
	...
	private String RoomID,AccountType;  //学号和账户类型
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tx_recharge.setOnTouchListener(new TouchListener());
		...
		tx_recharge.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				...
				String sUrl="http://10.100.0.4:8001/";							
