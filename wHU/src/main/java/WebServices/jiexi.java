	...
	public static ArrayList<Map<String, String>> inquiry_building_detail(SoapObject result) {
		...
		try{
			...
			for(int i=0;  i< result.getPropertyCount(); i++ ){
			    ...
			    try{map.put("ktStatus", soap.getProperty("ktStatus").toString());}catch(Exception e){}  //空调电表状态
			    try{map.put("ktState", soap.getProperty("ktState").toString());}catch(Exception e){}      //空调开关状态
